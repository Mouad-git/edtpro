...
$disable_csp = $_ENV['DISABLE_CSP'] ?? false;

if (!$disable_csp) {
    if ($environment === 'production') {
        // CSP stricte pour la production
        header('Content-Security-Policy: default-src \'self\'; script-src \'self\' \'unsafe-inline\' https://unpkg.com https://cdn.jsdelivr.net; style-src \'self\' \'unsafe-inline\' https://cdnjs.cloudflare.com; img-src \'self\' data: https:; font-src \'self\' https://cdnjs.cloudflare.com; connect-src \'self\';');
    } else {
