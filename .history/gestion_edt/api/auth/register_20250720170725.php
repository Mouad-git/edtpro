...
try {
    ...
    $mail->SMTPAuth   = true;
    $mail->Username   = 'pgst zzqh wlpo evuw';     // <<== REMPLACEZ PAR VOTRE EMAIL GMAIL
    $mail->Password   = 'mhdu bdyj wxrd hmaz';        // <<== REMPLACEZ PAR VOTRE MOT DE PASSE D'APPLICATION (16 caractères)
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;
    $mail->Port       = 465;
    $mail->CharSet    = 'UTF-8'; // Pour une bonne gestion des accents

    // Destinataires
    $mail->setFrom('mouadnouzri@gmail.com', 'Gestionnaire EDT'); // L'expéditeur
