...
try {
    ...
    $mail->SMTPAuth   = true;
    $mail->Username   = 'votre.adresse.email@gmail.com';     // <<== REMPLACEZ PAR VOTRE EMAIL GMAIL
    $mail->Password   = 'votremotdepassedeapplication';        // <<== REMPLACEZ PAR VOTRE MOT DE PASSE D'APPLICATION (16 caractères)
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;
    $mail->Port       = 465;
    $mail->CharSet    = 'UTF-8'; // Pour une bonne gestion des accents

    // Destinataires
    $mail->setFrom('votre.adresse.email@gmail.com', 'Gestionnaire EDT'); // L'expéditeur
    ...
    $mail->Body    = "
        <div style='font-family: Arial, sans-serif; line-height: 1.6;'>
            <h2>Bienvenue sur le Gestionnaire d'Emploi du Temps !</h2>
