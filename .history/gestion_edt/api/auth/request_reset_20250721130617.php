...
<div style='font-family: Arial, sans-serif; background-color: #f9f9f9; padding: 30px; color: #333;'>
    <div style='max-width: 600px; margin: auto; background: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 5px rgba(0,0,0,0.1);'>
        <div style='padding: 20px; text-align: center;'>
            <img src='https://www.tonsite.com/logo.png' alt='EDTpro' style='height: 60px; margin-bottom: 20px;' />
        ...
        <div style='padding: 20px; font-size: 16px; line-height: 1.5;'>
            ...
            <p style='text-align: center; margin: 30px 0;'>
                <a href='{$resetLink}' style='background-color: #28a745; color: #fff; text-decoration: none; padding: 12px 25px; border-radius: 5px; display: inline-block; font-weight: bold;'>
        ...
        <div style='background: #f0f0f0; text-align: center; padding: 15px; font-size: 12px; color: #888;'>
            &copy; ".date('Y')." EDTpro. Tous droits réservés.
        </div>
    </div>
</div>";
...
Vous recevez cet e-mail car une demande de réinitialisation de mot de passe a été effectuée pour votre compte EDTpro.
