...
try {
    ...
    foreach ($rows as $rowNumber => $row) {
        ...
        // --- MODIFICATIONS CRUCIALES ICI ---
        // Inclusion de s1_heures et s2_heures dans les affectations
    ...
    if(!empty($affectations)) $insertStmt->execute([$etablissement_id, 'affectation', json_encode($affectations)]); // Ce JSON contiendra maintenant s1_heures et s2_heures
