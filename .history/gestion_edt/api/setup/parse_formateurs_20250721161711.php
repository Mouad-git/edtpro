...
try {
    ...
    $matriculeIndex = array_search('<?php
// api/setup/parse_formateurs.php
...
try {
    ...
    // --- CORRECTION APPLIQUÉE ICI ---
    $nomFormateurIndex = array_search('Formateur Affecté Présentiel Actif', $header);
    $matriculeIndex = array_search('Matricule Formateur Présentiel', $header); // Assurez-vous que ce titre est bon
...
?>', $header); // Assurez-vous que ce titre est bon
